package com.taike.order.controller.gateway;
...
@RestController
public class FromGatewayController {

    private final Logger log = LoggerFactory.getLogger(FromGatewayController.class);
